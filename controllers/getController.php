...
class GetController {
    ...
    /* GET Petition relation tables with Filter Search */
    public function getBetweenRelData($rel, $type, $linkTo, $between1, $between2, $filterTo, $inTo, $not, $orderBy, $orderMode, $startAt, $endAt, $select){
        
        $response = GetModel::getBetweenRelData($rel, $type, $linkTo, $between1, $between2, $filterTo, $inTo, $not, $orderBy, $orderMode, $startAt, $endAt, $select);
    ...
    /* GET havong */
    public function getHaving($table, $linkTo, $equalTo, $groupBy, $orderBy, $orderMode, $startAt, $endAt, $select){
        
        $response = GetModel::getHaving($table, $linkTo, $equalTo, $groupBy, $orderBy, $orderMode, $startAt, $endAt, $select);
