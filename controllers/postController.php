...
class PostController{
    ...
    public function postLogin($table, $data){
        if(isset($data["email_user"]) && isset($data["password_user"])){
            $response = GetModel::getFilterData($table, "email_user", $data["email_user"],null, null, null, null, "name_user, lastname_user, image_user, city_user, phone_user, muni_user, direction_user, date_create_user, date_update_user, rol_user, password_user, id_user, email_user, token_user, token_exp_user, verificated_user, map_user,method_user");
